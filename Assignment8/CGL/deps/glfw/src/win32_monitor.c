  ...
  *count = 0;
  ...
  for (adapterIndex = 0;; adapterIndex++) {
    ...
    for (displayIndex = 0;; displayIndex++) {
      ...
      monitors[found] = _glfwAllocMonitor(name, GetDeviceCaps(dc, HORZSIZE),
...
void _glfwPlatformGetMonitorPos(_GLFWmonitor *monitor, int *xpos, int *ypos) {
  ...
  EnumDisplaySettingsExW(monitor->win32.adapterName, ENUM_CURRENT_SETTINGS,
                         &settings, EDS_ROTATEDMODE);
