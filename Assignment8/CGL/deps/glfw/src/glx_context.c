...
//
static GLboolean chooseFBConfig(const _GLFWfbconfig *desired,
                                GLXFBConfig *result) {
...
//
static GLXContext createLegacyContext(_GLFWwindow *window, GLXFBConfig fbconfig,
                                      GLXContext share) {
...
int _glfwInitContextAPI(void) {
  ...
  if (!glXQueryVersion(_glfw.x11.display, &_glfw.glx.versionMajor,
  ...
  if (_glfwPlatformExtensionSupported("GLX_EXT_swap_control")) {
    _glfw.glx.SwapIntervalEXT =
        (PFNGLXSWAPINTERVALEXTPROC)_glfwPlatformGetProcAddress(
            "glXSwapIntervalEXT");
  ...
  if (_glfwPlatformExtensionSupported("GLX_SGI_swap_control")) {
    _glfw.glx.SwapIntervalSGI =
        (PFNGLXSWAPINTERVALSGIPROC)_glfwPlatformGetProcAddress(
            "glXSwapIntervalSGI");
  ...
  if (_glfwPlatformExtensionSupported("GLX_MESA_swap_control")) {
    _glfw.glx.SwapIntervalMESA =
        (PFNGLXSWAPINTERVALMESAPROC)_glfwPlatformGetProcAddress(
            "glXSwapIntervalMESA");
  ...
  if (_glfwPlatformExtensionSupported("GLX_ARB_create_context")) {
    _glfw.glx.CreateContextAttribsARB =
        (PFNGLXCREATECONTEXTATTRIBSARBPROC)_glfwPlatformGetProcAddress(
...
int _glfwCreateContext(_GLFWwindow *window, const _GLFWctxconfig *ctxconfig,
  ...
  if (_glfw.glx.ARB_create_context) {
    ...
    window->glx.context = _glfw.glx.CreateContextAttribsARB(
...
void _glfwPlatformSwapInterval(int interval) {
  ...
  if (_glfw.glx.EXT_swap_control) {
    _glfw.glx.SwapIntervalEXT(_glfw.x11.display, window->x11.handle, interval);
