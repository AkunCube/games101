...
static void pointerHandleMotion(void *data, struct wl_pointer *pointer,
  ...
  _glfwInputCursorMotion(window, wl_fixed_to_double(sx),
...
static void pointerHandleButton(void *data, struct wl_pointer *wl_pointer,
  ...
  _glfwInputMouseClick(window, glfwButton,
                       state == WL_POINTER_BUTTON_STATE_PRESSED ? GLFW_PRESS
                                                                : GLFW_RELEASE,
...
static void keyboardHandleKeymap(void *data, struct wl_keyboard *keyboard,
  ...
  keymap = xkb_map_new_from_string(_glfw.wl.xkb.context, mapStr,
  ...
  _glfw.wl.xkb.alt_mask = 1
                          << xkb_map_mod_get_index(_glfw.wl.xkb.keymap, "Mod1");
...
static const struct wl_seat_listener seatListener = {seatHandleCapabilities};
...
static void registryHandleGlobal(void *data, struct wl_registry *registry,
  ...
  if (strcmp(interface, "wl_compositor") == 0) {
    ...
    _glfw.wl.shell = wl_registry_bind(registry, name, &wl_shell_interface, 1);
  } else if (strcmp(interface, "wl_output") == 0) {
    _glfwAddOutput(name, version);
  } else if (strcmp(interface, "wl_seat") == 0) {
    if (!_glfw.wl.seat) {
      _glfw.wl.seat = wl_registry_bind(registry, name, &wl_seat_interface, 1);
