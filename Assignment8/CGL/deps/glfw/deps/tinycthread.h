 ...
 * @param time_point A point in time at which the thread will resume (absolute
 * time).
 * @param remaining If non-NULL, this parameter will hold the remaining time
 * until time_point upon return. This will typically be zero, but if the thread
 * was woken up by a signal that is not ignored before time_point was reached @c
 * remaining will hold a positive time.
