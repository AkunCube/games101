...
#define out_msg(s)                                                             \
  std::cout << ANSI_B << "[CGL] " << ANSI_RESET << s << std::endl << std::flush
#define out_wrn(s)                                                             \
  std::cout << ANSI_Y << "[CGL] " << ANSI_RESET << s << std::endl << std::flush
#define out_err(s)                                                             \
  std::cout << ANSI_R << "[CGL] " << ANSI_RESET << s << std::endl << std::flush
